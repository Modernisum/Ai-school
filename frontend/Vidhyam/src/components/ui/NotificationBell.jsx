  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <Bell size={18} />
        {unreadCount > 0 && (
          <span className="absolute top-1 right-1 w-4 h-4 text-[10px] flex items-center justify-center rounded-full bg-red-500 text-white ring-2 ring-[#030712]">
        ...
        {dropdownOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 top-full mt-2 w-80 bg-slate-900 border border-white/10 rounded-2xl shadow-2xl overflow-hidden z-[100]"
            >
              {/* Header */}
