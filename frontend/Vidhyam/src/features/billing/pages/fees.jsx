            ...
            <div className="container mx-auto p-6 max-w-[1600px]">
                ...
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-base font-bold text-white tracking-tight leading-tight">Fees Ledger</h1>
                            <p className="text-[10px] font-medium text-slate-500 uppercase tracking-wider mt-0.5">{fees.length} active records • {customFees.length} definitions</p>
                        </div>
                    </div>
                    <div className="flex gap-2">
                        <button onClick={() => { refetchFees(); refetchCustom(); }} className="p-2 rounded-lg bg-white/5 border border-white/10 text-slate-400 hover:text-white hover:bg-white/10 transition-all duration-300">
                            <RefreshCw size={14} />
                        </button>
                        {activeTab === 'custom' && (
                            <button onClick={() => setShowAddCustom(true)} className="flex items-center gap-2 px-4 py-1.5 rounded-lg bg-primary text-white text-[11px] font-bold hover:brightness-110 shadow-lg shadow-primary/20 transition-all duration-300 active:scale-95">
