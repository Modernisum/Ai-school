...
export default function EmployeeFormPage() {
  ...
  // FIXED: Central API Helper with proper response handling
  const callApiWithBackoff = async (apiUrl, options = {}) => {
      ...
      for (let i = 0; i < MAX_RETRIES; i++) {
          try {
              ...
              // FIXED: Clone response before reading to avoid "body stream already read" error
              ...
              try {
                  ...
                  console.warn(`⚠️ Non-JSON response, trying text...`);
                  try {
