    ...
    Router::new()
        .nest(
            ...
            Router::new()
                ...
                .route("/syllabus/:responsibilityId/plot", post(syllabus_calendar::plot_annual))
                .route("/syllabus/:responsibilityId/micro-plan", post(syllabus_calendar::micro_plan_periods))
