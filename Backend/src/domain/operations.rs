use crate::routes::{complains, reminder, responsibility, responsibility_ws, task};
...
pub fn routes(state: AppState) -> Router<AppState> {
    ...
    Router::new()
        ...
        .route("/tasks/ai/generate", post(crate::routes::ai::ai_generate_tasks))
        .route("/tasks/ai/reorganize", post(crate::routes::ai::ai_reorganize_tasks))
        // Complaints
