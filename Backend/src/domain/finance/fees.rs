...
pub async fn apply_discount(
    ...
    let discount = payload["discount"].as_f64().or(payload["discount_amount"].as_f64()).unwrap_or(0.0);
...
pub async fn validate_coupon(
    ...
    let coupon_name = payload["couponName"].as_str().or(payload["code"].as_str()).unwrap_or("");
    let data = state
        .services
        .coupon
...
pub async fn use_coupon(
    ...
    let student_id = payload["studentId"].as_str().or(payload["student_id"].as_str()).unwrap_or("");
    let discount = payload["discount"].as_f64().or(payload["amount"].as_f64()).unwrap_or(0.0);
    let data = state
        .services
        .coupon
