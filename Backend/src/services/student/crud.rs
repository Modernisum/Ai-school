...
use super::validation::StudentValidation;

pub struct StudentCrud {
...
impl StudentCrud {
    ...
    pub async fn update_student(
        ...
        let delta = self.queries.calculate_delta(&old_student, &final_data);
    ...
    pub async fn resequence_roll_numbers(
        &self,
        school_id: &str,
        class_name: &str,
    ) -> AppResult<()> {
