...
pub fn create_router(state: AppState) -> Router {
    ...
    let api = Router::new()
        ...
        .route("/geo/countries", get(crate::domain::system::geo::get_countries))
        .route("/geo/states/:country_id", get(crate::domain::system::geo::get_states))
        .route("/geo/districts/:state_id", get(crate::domain::system::geo::get_districts))
        .route("/geo/export", get(crate::domain::system::geo::export_geo_json))
        .route("/geo/import", post(crate::domain::system::geo::import_geo_json).layer(axum::middleware::from_fn_with_state(
        state.clone(),
        crate_middleware::rls::rls_middleware,
    )))
        // Setup routes
        .route("/setup/school", post(crate::domain::system::setup::setup_school_handler))
        .route("/setup/:schoolId", get(crate::domain::system::setup::get_setup))
        ...
        .route(
            ...
            get(crate::domain::attendance::attendance::list_school_holidays)
                .post(crate::domain::attendance::attendance::create_school_holiday),
        )
        .route(
            "/school/:schoolId/holidays/check",
            get(crate::domain::attendance::attendance::check_school_holiday),
        )
        .route(
            "/school/:schoolId/holidays/:holidayId",
            axum::routing::delete(crate::domain::attendance::attendance::delete_school_holiday),
        )
        // Employee backward compatibility routes
        .route("/employees/:schoolId", get(crate::domain::people::employees::list_employees).post(crate::domain::people::employees::create_employee))
        .route("/employees/:schoolId/validate", post(crate::domain::people::employees::validate_employee))
        .route("/employees/:schoolId/bulk", post(crate::domain::people::employees::bulk_import_employees))
        .route(
            "/employees/:schoolId/:employeeId",
            get(crate::domain::people::employees::get_employee)
                .put(crate::domain::people::employees::update_employee)
                .delete(crate::domain::people::employees::delete_employee),
        )
        .route("/employees/:schoolId/:employeeId/salary-breakdown", get(crate::domain::people::emppay::get_salary_breakdown))
        .route("/employees/:schoolId/:employeeId/bonus", post(crate::domain::people::emppay::add_bonus))
        .route("/employees/:schoolId/:employeeId/aid", post(crate::domain::people::emppay::add_aid))
        .route("/employees/:schoolId/:employeeId/close-month", post(crate::domain::people::emppay::auto_close_month))
        .route("/employees/:schoolId/:employeeId/pay", post(crate::domain::people::emppay::record_salary_payment))
        .route("/employees/:schoolId/:employeeId/salary", post(crate::domain::people::emppay::set_base_salary))

        // Student backward compatibility routes
        .route("/students/:schoolId", get(crate::domain::people::students::list_students).post(crate::domain::people::students::create_student))
        .route("/students/:schoolId/validate", post(crate::domain::people::students::validate_student))
        .route("/students/:schoolId/bulk", post(crate::domain::people::students::bulk_import_students))
        .route("/students/:schoolId/paginated", get(crate::domain::people::students::list_students_paginated))
        .route("/students/:schoolId/studentIds", get(crate::domain::people::students::list_student_ids))
        .route(
            "/students/:schoolId/:studentId",
            get(crate::domain::people::students::get_student)
                .put(crate::domain::people::students::update_student)
                .delete(crate::domain::people::students::delete_student),
        )
        .route("/students/:schoolId/form-status", get(crate::domain::people::student_forms::get_form_status))
        .route("/students/:schoolId/:studentId/auto-fill", get(crate::domain::people::student_forms::auto_fill_form))
        .route("/students/:schoolId/:studentId/form-complete", post(crate::domain::people::student_forms::mark_form_complete))
    ...
    let app = Router::new()
        ...
        .route(
            ...
            get(crate::domain::leave::leave::get_proxy_suggestions),
        )
        .route(
            "/api/dashboard/:schoolId/overview",
            get(crate::domain::system::dashboard::get_dashboard_overview),
        )
        .route(
            "/api/dashboard/:schoolId/stats",
            get(crate::domain::system::dashboard::get_dashboard_stats),
        )
        .nest("/api", api)
        ...
        .route(
            ...
            get(crate::domain::finance::fees::get_student_profile),
        )
        // Middleware
