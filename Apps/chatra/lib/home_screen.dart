...
import 'widgets/home/spotlight_search_widget.dart';
import 'widgets/home/timetable_widget.dart';
import 'widgets/home/dashboard_stats_widget.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, dynamic>> _searchItems = [
    {
      ...
      "route": "/fees",
      "keywords": "pay, money, fees, transaction",
    },
    {
      "title": "Track Bus",
      "icon": Icons.gps_fixed_rounded,
      "route": "/bus-tracking",
      "keywords": "gps, bus, transport, live",
    },
    {
      "title": "Timetable",
    ...
    },
    {
      ...
      "route": "/attendance",
      "keywords": "absent, present, record",
    },
    {
      "title": "Vault",
      "icon": Icons.inventory_2_rounded,
      "route": "/vault",
      "keywords": "documents, reports, storage",
    },
    {
      "title": "Profile",
      "icon": Icons.person_outline_rounded,
      "route": "/profile",
      "keywords": "me, account, settings",
    },
  ];
  ...
  void _refreshDashboard() async {
    ...
    try {
      ...
      if (studentId != null && studentId.isNotEmpty) {
        ...
        debugPrint(
          "No student_id found in secure storage. Skipping dashboard fetch.",
        );
      }
    } catch (e) {
  ...
  Widget _buildBentoContent(DashboardLoaded state) {
    // Create combined dashboard data for the widget
    final dashboardData = {
