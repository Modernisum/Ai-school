...
import 'package:chatra/features/academic/bloc/academic_bloc.dart';
import 'package:chatra/features/academic/bloc/academic_event.dart';
import 'package:chatra/features/academic/bloc/academic_state.dart';
                    ...
                    children: [
                      ...
                      if (state.reportCards.isEmpty)
                        ...
                        ...state.reportCards.asMap().entries.map(
                          (e) =>
                              _buildDocCard(context, e.value).animate().fadeIn(
