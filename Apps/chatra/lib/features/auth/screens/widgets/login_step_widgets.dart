      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            labelStyle: GoogleFonts.outfit(color: AppColors.accentTeal),
    ...
    return Column(
      ...
      children: [
        ...
        TextButton(
          ...
          child: Text(
            "Change Phone Number",
            style: GoogleFonts.outfit(color: AppColors.accentTeal),
          ),
        ),
      ],
    ...
    return Column(
      ...
      children: [
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  leading: CircleAvatar(
                    ...
                    child: Text(
                      name[0].toUpperCase(),
                      style: GoogleFonts.outfit(color: AppColors.accentTeal, fontWeight: FontWeight.bold),
                    ),
                  ),
                  title: Text(
                    name,
        ...
        TextButton(
          ...
          child: Text("Switch Account", style: GoogleFonts.outfit()),
        ),
      ],
    );
  }
