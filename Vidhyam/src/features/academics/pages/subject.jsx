...
export default function SubjectManagement() {
  ...
  const { data: classMap = [], isLoading: loadingClasses } = useGetClassesQuery(schoolId);
  const classes = classMap.map(c => c.name || c.className || c);
  const loading = loadingSubjects || loadingClasses;
